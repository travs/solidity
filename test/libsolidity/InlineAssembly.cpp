...
BOOST_AUTO_TEST_CASE(for_visibility)
{
	...
	CHECK_PARSE_ERROR("{ for {} i { let i := 0} { } }", DeclarationError, "Identifier not found");
	CHECK_PARSE_ERROR("{ for {} 1 { let i := 0} { pop(i)} }", DeclarationError, "Identifier not found");
	CHECK_PARSE_ERROR("{ for { pop(i) } 1 { let i := 0} { } }", DeclarationError, "Identifier not found");
	CHECK_PARSE_ERROR("{ for {pop(i)} 1 { } { let i := 0 } }", DeclarationError, "Identifier not found");
	CHECK_PARSE_ERROR("{ for {} i { } { let i := 0 } }", DeclarationError, "Identifier not found");
	CHECK_PARSE_ERROR("{ for {} 1 { pop(i) } { let i := 0 } }", DeclarationError, "Identifier not found");
